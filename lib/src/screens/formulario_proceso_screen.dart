                                  ...
                                  onPressed: () async {
                                    ...
                                    final bool? confirmar =await showDialog<bool>(
                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          title: const Text('Confirmar creacion de proceso'),
                                          content: const Text('¿Desea crear el proceso?',
                                          ...
                                          actions: [
                                            Row(
                                              ...
                                              children: [
                                                TextButton(
                                                  onPressed: () {
                                                    Navigator.of(context).pop(true); // Cierra el modal y confirma
                                                  },
                                                  child: const Text('Sí',style: TextStyle(fontSize: 20),),
                                                ),
                                                TextButton(
                                                  onPressed: () {
                                                    Navigator.of(context).pop(false); // Cierra el modal y no confirma
                                                  },
                                    ...
                                    if (confirmar == true) {
                                      SeguimientoService _seguimientoService = SeguimientoService();
                                      ...
                                      final lote = await _loteCafeService.createLoteCafe(
                                        proveedorOrigen,
                                        proceso,
                                        variedad,
                                        peso);
                                      ...
                                      final seguimiento = await _seguimientoService.crearSeguimiento(
                                      ...
                                      Navigator.of(context).push(
                                        PageRouteBuilder(
                                          pageBuilder: (context, animation,secondaryAnimation) =>
                                              InformeMaquinaScreen(maquina:maquina),
