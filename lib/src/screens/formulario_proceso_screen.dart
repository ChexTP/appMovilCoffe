            ...
            child: Column(
              children: [
                ...
                DropdownButtonFormField<Map<String, String>>(
                  ...
                  value: variedad != null
                      ? variedadCafe
                          .firstWhere((element) => element['id'] == variedad)
                      : null,
                  style: const TextStyle(
                    color: Color.fromARGB(255, 185, 182, 182),
                    fontSize: 20,
                  ...
                  onChanged: (nuevoValor) {
                    setState(() {
                      variedad =
                          nuevoValor!['id']; // Guarda solo el id de la variedad
                    });
                  },
                  decoration: InputDecoration(
                    filled: true,
                ...
                DropdownButtonFormField<Map<String, String>>(
                  ...
                  value: proceso != null
                      ? tiposProcesos
                          .firstWhere((element) => element['id'] == proceso)
                      : null,
                  style: const TextStyle(
                    color: Color.fromARGB(255, 185, 182, 182),
                    fontSize: 20,
                      ...
                      child: Center(
                        child: IconButton(
                          onPressed: () async {
                            ...
                            // print('maquien en estado: $maquina')
                            final lote = await _loteCafeService.createLoteCafe(proveedorOrigen, proceso, variedad, peso);
                            print(lote);

                            final seguimiento = await _seguimientoService.crearSeguimiento(maquina.id, lote!, usuario.id);
                            print(seguimiento);
